...
namespace AtmosphericHeightFog
{
    public class HeightFogHub : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Atmospheric Height Fog is installed for the " + pipelineCurrent + "! Use the advanced settings below if you need to change the render pipeline support!", MessageType.Info, true);
                ...
                if (GUILayout.Button("Restart Render Pipeline Setup"))
                {
                    GetPipeline();

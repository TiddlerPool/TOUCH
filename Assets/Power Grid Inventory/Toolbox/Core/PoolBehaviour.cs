...
namespace Toolbox
{
    ...
    public abstract class PoolBehaviour<T> : MonoBehaviour where T : Component
    {
        ...
        public virtual T ObtainObject(Transform newOwner, float poolDelayTime = 0)
        {
            T thing = null;
        ...
        /// <param name="newOwner"></param>
        /// <returns>The desired component attached to the pooled object found.</returns>
        public virtual GameObject ObtainObjectNonValidate(Transform newOwner, float poolDelayTime = 0)
        {
        ...
        public virtual void RelenquishObject(T thing)
        {
        ...
        /// </summary>
        /// <param name="thing"></param>
        public virtual void RelenquishObject(GameObject thing)
        {

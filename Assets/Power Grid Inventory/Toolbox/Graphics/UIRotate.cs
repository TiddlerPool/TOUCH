...
namespace Toolbox.Graphics
{
    ...
    public class UIRotate : BaseMeshEffect
    {
        ...
        /// </summary>
        [Toolbox.Common.Inspectable("The angle in degrees at which the UI.Graphic will be displayed.")]
        ...
        /// </summary>
        [Toolbox.Common.Inspectable("The scale to apply to the UI.Graphics's verticies.")]
        ...
        /// <summary>
        /// If true, Scale will affect the size of the UI directly rather than work within the bounds of the UI's bounding box.
        /// </summary>
        [Tooltip("If true, Scale will affect the size of the UI directly rather than work within the bounds of the UI's bounding box.")]

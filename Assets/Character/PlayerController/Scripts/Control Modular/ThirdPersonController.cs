...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("If there is no fuel, character can not sprint")]
        public bool FuelNormal;
        ...
        private void Move()
        {
            // disable sprint state when character is static
            if (_input.move == Vector2.zero && _input.sprint == true)
                _input.sprint = false;
            float targetSpeed;
            // set target speed based on move speed, sprint speed and if sprint is pressed
            if (_input.sprint && FuelNormal)
            {
                targetSpeed = SprintSpeed; 
            }
            else if(_input.sprint && !FuelNormal)
            {
                targetSpeed = MoveSpeed;
                //Hint here, there is no fuel
            }
            else
            {
                targetSpeed = MoveSpeed;
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                _targetRotation = Mathf.Atan2(inputDirection.z, -inputDirection.x) * Mathf.Rad2Deg;
